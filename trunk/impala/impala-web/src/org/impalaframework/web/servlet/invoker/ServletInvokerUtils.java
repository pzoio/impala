...
public class ServletInvokerUtils {
	...
	public static void invoke(Object target, Object delegate, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		
		if (target instanceof HttpServiceInvoker) {
			HttpServiceInvoker invoker = (HttpServiceInvoker) target;
			invoker.invoke(delegate, request, response);
