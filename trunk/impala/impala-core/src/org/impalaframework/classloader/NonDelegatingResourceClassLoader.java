 ...
 * It's special behaviour is that when <code>getResources</code> is called,
 * the calls is delegated only to the
 ...
 * will not find resources visible to parent <code>ClassLoaders</code>s of
 * the delegate.
 * 
 * @author Phil Zoio
 */
