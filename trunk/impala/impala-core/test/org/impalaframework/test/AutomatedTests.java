...
import org.impalaframework.plugin.spec.transition.PluginTransitionManagerMockTest;
import org.impalaframework.plugin.spec.transition.PluginTransitionManagerTest;
...
public class AutomatedTests {
	...
	public static Test suite() {
		...
		suite.addTestSuite(PluginTransitionManagerTest.class);
		suite.addTestSuite(PluginTransitionManagerMockTest.class);
