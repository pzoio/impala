...
public class GraphBasedClassLoaderTest extends TestCase {
	...
	public void testClassLoader() throws Exception {
		...
		new SimpleModuleDefinition(newC, "module-e", null, new String[]{ "module-b" }, null);
	...
	private ModuleDefinition newDefinition(List<ModuleDefinition> list, final String name, final String dependencies) {
		...
		ModuleDefinition definition = new SimpleModuleDefinition(null, "module-" + name, null, split, null);
		list.add(definition);
		return definition;
	}
	
	private ModuleDefinition newDefinition(List<ModuleDefinition> list, final String name) {
		ModuleDefinition definition = new SimpleModuleDefinition(null, "module-" + name, null, new String[0], null);
		list.add(definition);
		return definition;
	}
