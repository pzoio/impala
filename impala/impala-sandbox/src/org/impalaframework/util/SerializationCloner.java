...
/**
 * This code is based on the article: http://weblogs.java.net/blog/emcmanus/archive/2007/04/cloning_java_ob.html
 * @author Phil Zoio
 */
public class SerializationCloner {

	private static final Log logger = LogFactory.getLog(SerializationCloner.class);
	...
	private static class CloneInput extends ObjectInputStream {
		...
		protected Class<?> resolveClass(ObjectStreamClass osc)
			...
			if (logger.isDebugEnabled()) 
				logger.debug("resolveClass: " + c.getName());
