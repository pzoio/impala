 ...
 * @author Phil Zoio
 */
public abstract class BaseServiceProxyFactoryCreator implements ServiceRegistryAware, ServiceProxyFactoryCreator {
	...
	protected abstract ContributionEndpointTargetSource newTargetSource(ServiceRegistry serviceRegistry, String registryKeyName);
