...
public class StickyModuleModificationCalculatorTest extends TestCase {
	...
	public final void testCheckOriginal() {
		...
		ModuleModificationCalculator stickyCalculator = new StickyModuleModificationCalculator();
