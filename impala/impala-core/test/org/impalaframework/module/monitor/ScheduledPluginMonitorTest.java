...
import org.impalaframework.module.monitor.ScheduledPluginMonitor;
...
public class ScheduledPluginMonitorTest extends TestCase {
	...
	public final void testMonitor() throws Exception {
		...
		final RecordingPluginModificationListener listener = new RecordingPluginModificationListener();
		...
		List<PluginModificationEvent> events = listener.getEvents();
