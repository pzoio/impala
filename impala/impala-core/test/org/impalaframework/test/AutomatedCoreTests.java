...
import org.impalaframework.module.transition.ModuleStateManagerMockTest;
import org.impalaframework.module.transition.ModuleStateManagerTest;
...
public class AutomatedCoreTests {
	...
	public static Test suite() {
		...
		suite.addTestSuite(ModuleStateManagerTest.class);
		suite.addTestSuite(RemoveModuleOperationTest.class);
		suite.addTestSuite(ModuleStateManagerMockTest.class);
