...
public class GraphHelper
{
    ...
    private static void addDependencies(final Vertex vertex, final List<Vertex> vertices)
    {
        if ( !vertices.contains( vertex ) )
        {
            ...
            for ( Iterator<Vertex> iter = vertex.getDependencies().iterator(); iter.hasNext(); )
            {
        ...
        throws CyclicDependencyException
    {
        ...
        while ( it.hasNext() )
        {
            ...
            Iterator<Vertex> dit = v.getDependencies().iterator();
            while( dit.hasNext() )
            {
                Vertex dv = dit.next();
     ...
     * @throws CyclicDependencyException
     */
    public static void topologicalSort( final List<Vertex> vertices ) throws CyclicDependencyException
    {
     ...
     * @param vertices
     */
    public static void resetVertices( List<Vertex> vertices )
    {
        Iterator<Vertex> it = vertices.iterator();
        while ( it.hasNext() )
        {
